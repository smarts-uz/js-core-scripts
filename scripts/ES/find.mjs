// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for ES.find.
// Edit the method in classes/ES.js, then re-run the generator to refresh.
// Calls ES.find(...) directly; no shared engine.
//
...
async function main() {
    ...
    const run = async () => {
        const result = await ES.find(argv["name"], argv["instance"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'ES find Error');
