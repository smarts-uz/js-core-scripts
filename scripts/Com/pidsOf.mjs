// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Com.pidsOf.
// Edit the method in classes/Com.js, then re-run the generator to refresh.
// Calls Com.pidsOf(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Com pidsOf Start');
    ...
    const run = async () => {
        const result = await Com.pidsOf(argv["imageName"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Com pidsOf Error');
    ...
    console.log('3️⃣ Com pidsOf Done');
}
