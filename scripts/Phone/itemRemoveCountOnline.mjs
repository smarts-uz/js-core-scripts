// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.itemRemoveCountOnline.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.itemRemoveCountOnline(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone itemRemoveCountOnline Start');
    ...
    const run = async () => {
        const result = await Phone.itemRemoveCountOnline(argv["name"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone itemRemoveCountOnline Error');
    ...
    console.log('3️⃣ Phone itemRemoveCountOnline Done');
}
