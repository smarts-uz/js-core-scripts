// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.getNoPhones.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.getNoPhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone getNoPhones Start');
    ...
    const run = async () => {
        const result = await Phone.getNoPhones();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone getNoPhones Error');
    ...
    console.log('3️⃣ Phone getNoPhones Done');
}
