// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.appMergePhones.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.appMergePhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone appMergePhones Start');
    ...
    const run = async () => {
        const result = await Phone.appMergePhones();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone appMergePhones Error');
    ...
    console.log('3️⃣ Phone appMergePhones Done');
}
