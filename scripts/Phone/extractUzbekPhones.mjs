// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.extractUzbekPhones.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.extractUzbekPhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone extractUzbekPhones Start');
    ...
    const run = async () => {
        const result = await Phone.extractUzbekPhones(argv["text"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone extractUzbekPhones Error');
    ...
    console.log('3️⃣ Phone extractUzbekPhones Done');
}
