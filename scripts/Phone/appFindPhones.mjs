// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.appFindPhones.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.appFindPhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone appFindPhones Start');
    ...
    const run = async () => {
        const result = await Phone.appFindPhones();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone appFindPhones Error');
    ...
    console.log('3️⃣ Phone appFindPhones Done');
}
