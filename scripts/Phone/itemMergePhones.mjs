// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.itemMergePhones.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.itemMergePhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone itemMergePhones Start');
    ...
    const run = async () => {
        const result = await Phone.itemMergePhones(argv["folder"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone itemMergePhones Error');
    ...
    console.log('3️⃣ Phone itemMergePhones Done');
}
