// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Phone.appCalculateCountOnline.
// Edit the method in classes/Phone.js, then re-run the generator to refresh.
// Calls Phone.appCalculateCountOnline(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Phone appCalculateCountOnline Start');
    ...
    const run = async () => {
        const result = await Phone.appCalculateCountOnline();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Phone appCalculateCountOnline Error');
    ...
    console.log('3️⃣ Phone appCalculateCountOnline Done');
}
