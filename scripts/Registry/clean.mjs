// AUTO-GENERATED by runs/_generate.mjs — standalone runner for Registry.clean.
// Edit the method in utils/Registry.js, then re-run the generator to refresh.
...
// config.yml) from dirname(process.argv[1]). runs/Registry/ is two levels
// below root, so '..','..' = root.
