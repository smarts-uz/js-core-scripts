// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Homoglyph.powerpointAsk.
// Edit the method in humanize/classes/Homoglyph.js, then re-run the generator to refresh.
// Calls Homoglyph.powerpointAsk(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Homoglyph powerpointAsk Start');
    ...
    const run = async () => {
        const result = await Homoglyph.powerpointAsk(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Homoglyph powerpointAsk Error');
    ...
    console.log('3️⃣ Homoglyph powerpointAsk Done');
}
