// AUTO-GENERATED by runs/_generate.mjs — standalone runner for Secrets.get.
// Edit the method in utils/Secrets.js, then re-run the generator to refresh.
...
// config.yml) from dirname(process.argv[1]). runs/Secrets/ is two levels
// below root, so '..','..' = root.
