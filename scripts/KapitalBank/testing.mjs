// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for KapitalBank.testing.
// Edit the method in classes/KapitalBank.js, then re-run the generator to refresh.
// Calls KapitalBank.testing(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ KapitalBank testing Start');
    ...
    const run = async () => {
        const result = await KapitalBank.testing();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'KapitalBank testing Error');
    ...
    console.log('3️⃣ KapitalBank testing Done');
}
