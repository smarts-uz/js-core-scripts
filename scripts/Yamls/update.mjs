// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Yamls.update.
// Edit the method in classes/Yamls.js, then re-run the generator to refresh.
// Calls Yamls.update(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Yamls update Start');
    ...
    const run = async () => {
        const result = await Yamls.update(argv["yaml"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Yamls update Error');
    ...
    console.log('3️⃣ Yamls update Done');
}
