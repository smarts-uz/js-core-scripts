// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.scrollAds.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.scrollAds(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe scrollAds Start');
    ...
    const run = async () => {
        const result = await Puppe.scrollAds();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe scrollAds Error');
    ...
    console.log('3️⃣ Puppe scrollAds Done');
}
