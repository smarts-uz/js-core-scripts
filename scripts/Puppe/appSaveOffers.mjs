// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.appSaveOffers.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.appSaveOffers(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe appSaveOffers Start');
    ...
    const run = async () => {
        const result = await Puppe.appSaveOffers();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe appSaveOffers Error');
    ...
    console.log('3️⃣ Puppe appSaveOffers Done');
}
