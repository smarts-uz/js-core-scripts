// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.showPhone.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.showPhone(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe showPhone Start');
    ...
    const run = async () => {
        const result = await Puppe.showPhone();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe showPhone Error');
    ...
    console.log('3️⃣ Puppe showPhone Done');
}
