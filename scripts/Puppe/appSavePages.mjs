// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.appSavePages.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.appSavePages(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe appSavePages Start');
    ...
    const run = async () => {
        const result = await Puppe.appSavePages();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe appSavePages Error');
    ...
    console.log('3️⃣ Puppe appSavePages Done');
}
