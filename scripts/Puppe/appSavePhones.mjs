// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.appSavePhones.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.appSavePhones(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe appSavePhones Start');
    ...
    const run = async () => {
        const result = await Puppe.appSavePhones();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe appSavePhones Error');
    ...
    console.log('3️⃣ Puppe appSavePhones Done');
}
