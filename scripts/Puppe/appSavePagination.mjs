// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Puppe.appSavePagination.
// Edit the method in classes/Puppe.js, then re-run the generator to refresh.
// Calls Puppe.appSavePagination(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Puppe appSavePagination Start');
    ...
    const run = async () => {
        const result = await Puppe.appSavePagination();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Puppe appSavePagination Error');
    ...
    console.log('3️⃣ Puppe appSavePagination Done');
}
