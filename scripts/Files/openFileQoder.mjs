// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Files.openFileQoder.
// Edit the method in classes/Files.js, then re-run the generator to refresh.
// Calls Files.openFileQoder(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Files openFileQoder Start');
    ...
    const run = async () => {
        const result = await Files.openFileQoder(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Files openFileQoder Error');
    ...
    console.log('3️⃣ Files openFileQoder Done');
}
