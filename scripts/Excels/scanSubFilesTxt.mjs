// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.scanSubFilesTxt.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.scanSubFilesTxt(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels scanSubFilesTxt Start');
    ...
    const run = async () => {
        const result = await Excels.scanSubFilesTxt(argv["folder"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels scanSubFilesTxt Error');
    ...
    console.log('3️⃣ Excels scanSubFilesTxt Done');
}
