// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.protectSheetAsk.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.protectSheetAsk(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels protectSheetAsk Start');
    ...
    const run = async () => {
        const result = await Excels.protectSheetAsk(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels protectSheetAsk Error');
    ...
    console.log('3️⃣ Excels protectSheetAsk Done');
}
