// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPriceDay.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPriceDay(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPriceDay Start');
    ...
    const run = async () => {
        const result = await Excels.processPriceDay(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPriceDay Error');
    ...
    console.log('3️⃣ Excels processPriceDay Done');
}
