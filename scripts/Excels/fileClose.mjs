// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.fileClose.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.fileClose(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels fileClose Start');
    ...
    const run = async () => {
        const result = await Excels.fileClose();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels fileClose Error');
    ...
    console.log('3️⃣ Excels fileClose Done');
}
