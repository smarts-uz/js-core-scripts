// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPenaltyDays.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPenaltyDays(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPenaltyDays Start');
    ...
    const run = async () => {
        const result = await Excels.processPenaltyDays(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPenaltyDays Error');
    ...
    console.log('3️⃣ Excels processPenaltyDays Done');
}
