// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processReturns.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processReturns(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processReturns Start');
    ...
    const run = async () => {
        const result = await Excels.processReturns(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processReturns Error');
    ...
    console.log('3️⃣ Excels processReturns Done');
}
