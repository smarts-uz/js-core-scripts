// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processFaktura.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processFaktura(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processFaktura Start');
    ...
    const run = async () => {
        const result = await Excels.processFaktura(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processFaktura Error');
    ...
    console.log('3️⃣ Excels processFaktura Done');
}
