// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processAccount.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processAccount(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processAccount Start');
    ...
    const run = async () => {
        const result = await Excels.processAccount(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processAccount Error');
    ...
    console.log('3️⃣ Excels processAccount Done');
}
