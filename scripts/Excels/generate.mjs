// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.generate.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.generate(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels generate Start');
    ...
    const run = async () => {
        const result = await Excels.generate(argv["yaml"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels generate Error');
    ...
    console.log('3️⃣ Excels generate Done');
}
