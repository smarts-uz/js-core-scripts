// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPriceMaxDay.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPriceMaxDay(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPriceMaxDay Start');
    ...
    const run = async () => {
        const result = await Excels.processPriceMaxDay(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPriceMaxDay Error');
    ...
    console.log('3️⃣ Excels processPriceMaxDay Done');
}
