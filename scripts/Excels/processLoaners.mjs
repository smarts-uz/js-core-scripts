// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processLoaners.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processLoaners(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processLoaners Start');
    ...
    const run = async () => {
        const result = await Excels.processLoaners(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processLoaners Error');
    ...
    console.log('3️⃣ Excels processLoaners Done');
}
