// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.checkWinax.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.checkWinax(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels checkWinax Start');
    ...
    const run = async () => {
        const result = await Excels.checkWinax(argv["methodName"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels checkWinax Error');
    ...
    console.log('3️⃣ Excels checkWinax Done');
}
