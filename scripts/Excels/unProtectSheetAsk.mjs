// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.unProtectSheetAsk.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.unProtectSheetAsk(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels unProtectSheetAsk Start');
    ...
    const run = async () => {
        const result = await Excels.unProtectSheetAsk(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels unProtectSheetAsk Error');
    ...
    console.log('3️⃣ Excels unProtectSheetAsk Done');
}
