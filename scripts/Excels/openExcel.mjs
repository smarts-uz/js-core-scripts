// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.openExcel.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.openExcel(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels openExcel Start');
    ...
    const run = async () => {
        const result = await Excels.openExcel(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels openExcel Error');
    ...
    console.log('3️⃣ Excels openExcel Done');
}
