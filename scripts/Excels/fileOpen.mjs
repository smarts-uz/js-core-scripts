// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.fileOpen.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.fileOpen(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels fileOpen Start');
    ...
    const run = async () => {
        const result = await Excels.fileOpen(argv["file"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels fileOpen Error');
    ...
    console.log('3️⃣ Excels fileOpen Done');
}
