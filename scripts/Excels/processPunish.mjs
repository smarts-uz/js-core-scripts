// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPunish.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPunish(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPunish Start');
    ...
    const run = async () => {
        const result = await Excels.processPunish(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPunish Error');
    ...
    console.log('3️⃣ Excels processPunish Done');
}
