// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.unhide.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.unhide(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels unhide Start');
    ...
    const run = async () => {
        const result = await Excels.unhide(argv["file"], argv["sheetName"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels unhide Error');
    ...
    console.log('3️⃣ Excels unhide Done');
}
