// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.fileSave.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.fileSave(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels fileSave Start');
    ...
    const run = async () => {
        const result = await Excels.fileSave();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels fileSave Error');
    ...
    console.log('3️⃣ Excels fileSave Done');
}
