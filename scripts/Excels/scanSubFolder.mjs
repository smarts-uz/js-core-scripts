// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.scanSubFolder.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.scanSubFolder(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels scanSubFolder Start');
    ...
    const run = async () => {
        const result = await Excels.scanSubFolder(argv["folder"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels scanSubFolder Error');
    ...
    console.log('3️⃣ Excels scanSubFolder Done');
}
