// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.findColumn.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.findColumn(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels findColumn Start');
    ...
    const run = async () => {
        const result = await Excels.findColumn(argv["search"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels findColumn Error');
    ...
    console.log('3️⃣ Excels findColumn Done');
}
