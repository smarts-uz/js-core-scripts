// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPricing.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPricing(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPricing Start');
    ...
    const run = async () => {
        const result = await Excels.processPricing(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPricing Error');
    ...
    console.log('3️⃣ Excels processPricing Done');
}
