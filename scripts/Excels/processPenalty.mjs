// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Excels.processPenalty.
// Edit the method in classes/Excels.js, then re-run the generator to refresh.
// Calls Excels.processPenalty(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Excels processPenalty Start');
    ...
    const run = async () => {
        const result = await Excels.processPenalty(argv["yamlData"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Excels processPenalty Error');
    ...
    console.log('3️⃣ Excels processPenalty Done');
}
