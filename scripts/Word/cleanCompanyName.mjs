// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Word.cleanCompanyName.
// Edit the method in classes/Word.js, then re-run the generator to refresh.
// Calls Word.cleanCompanyName(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Word cleanCompanyName Start');
    ...
    const run = async () => {
        const result = await Word.cleanCompanyName(argv["name"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Word cleanCompanyName Error');
    ...
    console.log('3️⃣ Word cleanCompanyName Done');
}
