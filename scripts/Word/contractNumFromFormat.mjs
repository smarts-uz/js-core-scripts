// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Word.contractNumFromFormat.
// Edit the method in classes/Word.js, then re-run the generator to refresh.
// Calls Word.contractNumFromFormat(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Word contractNumFromFormat Start');
    ...
    const run = async () => {
        const result = await Word.contractNumFromFormat(argv["data"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Word contractNumFromFormat Error');
    ...
    console.log('3️⃣ Word contractNumFromFormat Done');
}
