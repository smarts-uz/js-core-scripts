// AUTO-GENERATED self-contained runner — Olx.offers.
// Feature: OLX Offers (save offers). Runs the scraper pipeline by calling Chromes/Puppe/Phone
...
async function main() {
    console.log('1️⃣ Olx offers Start');
    ...
    console.log('3️⃣ Olx offers Done');
}
