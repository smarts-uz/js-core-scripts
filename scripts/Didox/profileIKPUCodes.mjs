// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Didox.profileIKPUCodes.
// Edit the method in classes/Didox.js, then re-run the generator to refresh.
// Calls Didox.profileIKPUCodes(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Didox profileIKPUCodes Start');
    ...
    const run = async () => {
        const result = await Didox.profileIKPUCodes();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Didox profileIKPUCodes Error');
    ...
    console.log('3️⃣ Didox profileIKPUCodes Done');
}
