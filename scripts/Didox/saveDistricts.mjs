// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Didox.saveDistricts.
// Edit the method in classes/Didox.js, then re-run the generator to refresh.
// Calls Didox.saveDistricts(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Didox saveDistricts Start');
    ...
    const run = async () => {
        const result = await Didox.saveDistricts();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Didox saveDistricts Error');
    ...
    console.log('3️⃣ Didox saveDistricts Done');
}
