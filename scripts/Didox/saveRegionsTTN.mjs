// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Didox.saveRegionsTTN.
// Edit the method in classes/Didox.js, then re-run the generator to refresh.
// Calls Didox.saveRegionsTTN(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Didox saveRegionsTTN Start');
    ...
    const run = async () => {
        const result = await Didox.saveRegionsTTN();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Didox saveRegionsTTN Error');
    ...
    console.log('3️⃣ Didox saveRegionsTTN Done');
}
