// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Didox.documentList.
// Edit the method in classes/Didox.js, then re-run the generator to refresh.
// Calls Didox.documentList(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Didox documentList Start');
    ...
    const run = async () => {
        const result = await Didox.documentList();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Didox documentList Error');
    ...
    console.log('3️⃣ Didox documentList Done');
}
