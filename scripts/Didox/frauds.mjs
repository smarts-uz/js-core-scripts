// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Didox.frauds.
// Edit the method in classes/Didox.js, then re-run the generator to refresh.
// Calls Didox.frauds(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Didox frauds Start');
    ...
    const run = async () => {
        const result = await Didox.frauds();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Didox frauds Error');
    ...
    console.log('3️⃣ Didox frauds Done');
}
