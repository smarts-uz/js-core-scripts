// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.closeChrome.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.closeChrome(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes closeChrome Start');
    ...
    const run = async () => {
        const result = await Chromes.closeChrome();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes closeChrome Error');
    ...
    console.log('3️⃣ Chromes closeChrome Done');
}
