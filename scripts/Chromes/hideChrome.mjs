// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.hideChrome.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.hideChrome(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes hideChrome Start');
    ...
    const run = async () => {
        const result = await Chromes.hideChrome();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes hideChrome Error');
    ...
    console.log('3️⃣ Chromes hideChrome Done');
}
