// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.closeBrowsers.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.closeBrowsers(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes closeBrowsers Start');
    ...
    const run = async () => {
        const result = await Chromes.closeBrowsers();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes closeBrowsers Error');
    ...
    console.log('3️⃣ Chromes closeBrowsers Done');
}
