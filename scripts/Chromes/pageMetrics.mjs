// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.pageMetrics.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.pageMetrics(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes pageMetrics Start');
    ...
    const run = async () => {
        const result = await Chromes.pageMetrics();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes pageMetrics Error');
    ...
    console.log('3️⃣ Chromes pageMetrics Done');
}
