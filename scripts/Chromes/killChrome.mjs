// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.killChrome.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.killChrome(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes killChrome Start');
    ...
    const run = async () => {
        const result = await Chromes.killChrome();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes killChrome Error');
    ...
    console.log('3️⃣ Chromes killChrome Done');
}
