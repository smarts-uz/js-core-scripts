// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.showChrome.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.showChrome(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes showChrome Start');
    ...
    const run = async () => {
        const result = await Chromes.showChrome();
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes showChrome Error');
    ...
    console.log('3️⃣ Chromes showChrome Done');
}
