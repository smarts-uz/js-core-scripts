// AUTO-GENERATED by scripts/_generate.mjs — standalone runner for Chromes.runIxbrowser.
// Edit the method in classes/Chromes.js, then re-run the generator to refresh.
// Calls Chromes.runIxbrowser(...) directly; no shared engine.
//
...
async function main() {
    console.log('1️⃣ Chromes runIxbrowser Start');
    ...
    const run = async () => {
        const result = await Chromes.runIxbrowser(argv["isCmdGo"]);
    ...
    if (Yamls.getConfig('CmdLine.TryCatch') === 'true') {
        try {
            ...
            Dialogs.warningBox(error.message, 'Chromes runIxbrowser Error');
    ...
    console.log('3️⃣ Chromes runIxbrowser Done');
}
