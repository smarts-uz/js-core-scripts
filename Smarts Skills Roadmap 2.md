...
> ☑ **Completion status (2026-07-02):** all 85 tasks in this roadmap were implemented in the same session, prompt-first via smarts-skill-manager across 28 smarts-* skills. Every skill test suite is green (0 failures fleet-wide); all changes committed and pushed. Rows below are marked ☑ done.
