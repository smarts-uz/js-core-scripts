...
// path of the classes module removes the ambiguity — Claude's `import './Files.js'`
...
export const UTILS_DIR = path.resolve(HERE, '..', '..', 'classes');

/** Absolute path of a classes module, e.g. utilsModule('Files.js'). */
