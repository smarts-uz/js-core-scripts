// AUTO-GENERATED by runs/_generate.mjs — standalone runner for ES.findIn.
// Edit the method in utils/ES.js, then re-run the generator to refresh.
...
// config.yml) from dirname(process.argv[1]). runs/ES/ is two levels
// below root, so '..','..' = root.
