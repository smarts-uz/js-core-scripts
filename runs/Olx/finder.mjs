// AUTO-GENERATED self-contained runner — Olx.finder.
// Feature: OLX Finder (find phones). Runs the scraper pipeline by calling Chromes/Puppe/Phone
...
async function main() {
    console.log('1️⃣ Olx finder Start');
    ...
    console.log('3️⃣ Olx finder Done');
}
