// AUTO-GENERATED by runs/_generate.mjs — standalone runner for Homoglyph.powerpoint.
// Edit the method in utils/Homoglyph.js, then re-run the generator to refresh.
...
// config.yml) from dirname(process.argv[1]). runs/Homoglyph/ is two levels
// below root, so '..','..' = root.
